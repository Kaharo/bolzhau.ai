...
def load_bigram_model(model_path="models/compressed/compressed_bi_gram_model.pkl"):
    global BIGRAM_MODEL
...
def load_trigram_model(model_path="models/compressed/compressed_tri_gram_model.pkl"):
